    var nyatoriCommentWrapper0511CSS = "<style>\n" +
        ...
        "    }\n" +
        "    .nyatoriCommentWrapper0511 #commentList .commentContainer .commentMore {\n" +
        "        background: #eee;\n" +
        "        border-radius: .3rem;\n" +
        "        user-select: none;\n" +
        "        cursor: pointer;\n" +
    ...
    var nyatoriCommentWrapper0511 = "<div id=\"commentApp\" style=\"display: none\">\n" +
        ...
        "                    </div>\n" +
        "                    <div v-if=\"index === commentList.length - 1 && commentData.more\" class=\"commentMore\" @click=\"getOneComment(commentData.current, true)\">加载更多</div>\n" +
        "                </div>\n" +
